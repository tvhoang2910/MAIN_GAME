...
void runGameLoop(SDL_Renderer* renderer, SDL_Window* window, TTF_Font* font, SDL_Texture* backgroundTexture,
    ...
    while (isRunning) {
        ...
        if (numHeartsRemaining <= 0) {
            ...
            SDL_Rect textRect = { (SCREEN_WIDTH - textWidth) / 2, (SCREEN_HEIGHT - textHeight) / 2, textWidth, textHeight }; // V? tr� �? hi?n th? th�ng b�o "Game Over"
        ...
        if (score >= 200) {
            ...
            SDL_Rect textRect = { (SCREEN_WIDTH - textWidth) / 2, (SCREEN_HEIGHT - textHeight) / 2, textWidth, textHeight }; // V? tr� �? hi?n th? th�ng b�o "You Win"
